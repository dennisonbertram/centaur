...
- The user asks to continue earlier migration work, extend a prior PR's schema, or preserve an established table/layout contract.
- The task explicitly targets an overlay migration set.
